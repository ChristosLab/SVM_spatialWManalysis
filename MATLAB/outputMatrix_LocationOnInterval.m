function [ fulldata ] = genSVM_PseudoMultiNeuron( filenames, tslower, tsupper, outfilename )
%Generate CSV file for classifying cue location using activity from some interval.
...
for i=1:9
    ...
    for j=1:20
        ...
        % make the SVM entry (not yet sparse, but it doesn't have to be sparse if R package e1071 used to analyse)
